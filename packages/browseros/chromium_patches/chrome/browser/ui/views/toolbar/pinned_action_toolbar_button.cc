...
+  // Special case for Clash of GPTs and Third Party LLM - use custom blue-purple color
+  if (action_id_ == kActionSidePanelShowClashOfGpts ||
+      action_id_ == kActionSidePanelShowThirdPartyLlm) {
+    const SkColor bluepurple = SkColorSetRGB(0x63, 0x66, 0xf1);
+    UpdateIconsWithColors(icon, bluepurple, bluepurple, bluepurple, 
