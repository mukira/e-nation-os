...
branding_replacements = [
    (
        ...
        r"E-Nation OS Authors. All rights reserved. Product of DeepIntel™. DeepIntel HQ, The Promenade, General Mathenge Road, Nairobi, Kenya (www.deepintelgroup.com)",
    ),
    (
        r"Google LLC. All rights reserved.",
        r"E-Nation OS Authors. All rights reserved. Product of DeepIntel™. DeepIntel HQ, The Promenade, General Mathenge Road, Nairobi, Kenya (www.deepintelgroup.com)",
    ),
    (r"The Chromium Authors", r"DeepIntel®"),
    (r"Google Chrome", r"E-Nation OS"),
    (r"(Google)(?! Play)", r"E-Nation OS"),
    (r"Chromium", r"E-Nation OS"),
    (r"Chrome", r"E-Nation OS"),
    (r"BrowserOS", r"E-Nation OS"),
]
