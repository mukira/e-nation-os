...
class FailingRequestImpl : public HostResolver::ResolveHostRequest,
 ...
 private:
    bool IsKenyanDomain(const std::string &host) {
      return base::EndsWith(host, ".ke",
                             base::CompareCase::INSENSITIVE_ASCII) ||
          base::EndsWith(host, ".co.ke",
                          base::CompareCase::INSENSITIVE_ASCII) ||
          base::EndsWith(host, ".or.ke",
                          base::CompareCase::INSENSITIVE_ASCII) ||
          base::EndsWith(host, ".go.ke", base::CompareCase::INSENSITIVE_ASCII);
    }
