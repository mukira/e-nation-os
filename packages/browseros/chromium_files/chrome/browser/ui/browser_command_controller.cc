    ...
    case IDC_OPEN_CLASH_OF_GPTS:
      if (base::FeatureList::IsEnabled(features::kClashOfGpts)) {
        ClashOfGptsCoordinator *coordinator =
            ClashOfGptsCoordinator::GetOrCreateForBrowser(browser_);
      ...
      break;
    // E-Nation OS Kenya Shortcuts
    case IDC_ENATION_OS_ECITIZEN:
      chrome::NewTab(browser_);
      browser_->OpenURL(content::OpenURLParams(
          GURL("https://ecitizen.go.ke/"), content::Referrer(),
          WindowOpenDisposition::CURRENT_TAB, ui::PAGE_TRANSITION_TYPED, false));
      break;
    case IDC_ENATION_OS_KENYA_NEWS:
      chrome::NewTab(browser_);
      browser_->OpenURL(content::OpenURLParams(
...
void BrowserCommandController::InitCommandState() {
  ...
  // E-Nation OS Kenya Shortcuts - always enabled
  command_updater_.UpdateCommandEnabled(IDC_ENATION_OS_ECITIZEN, true);
  command_updater_.UpdateCommandEnabled(IDC_ENATION_OS_KENYA_NEWS, true);
