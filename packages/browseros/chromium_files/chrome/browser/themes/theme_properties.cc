...
// E-Nation OS Custom Themes
// Kenya Green Theme
const SkColor kKenyaGreenFrame = SkColorSetRGB(0x00, 0x7a, 0x3d); // Kenya flag green
const SkColor kKenyaGreenToolbar = SkColorSetRGB(0x22, 0xc5, 0x5e); // Light green
const SkColor kKenyaGreenTab = SkColorSetRGB(0x16, 0xa3, 0x4a);
const SkColor kKenyaGreenText = SkColorSetRGB(0xFF, 0xFF, 0xFF);

// Safari Theme (Nature-inspired)
const SkColor kSafariFrame = SkColorSetRGB(0xd9, 0x77, 0x06); // Sunset orange
const SkColor kSafariToolbar = SkColorSetRGB(0xfd, 0xba, 0x74); // Light orange
const SkColor kSafariTab = SkColorSetRGB(0xf5, 0x9e, 0x0b);
const SkColor kSafariText = SkColorSetRGB(0x0f, 0x17, 0x2a);

// Nairobi Blue Theme
const SkColor kNairobiBlueFrame = SkColorSetRGB(0x1e, 0x40, 0xaf);
const SkColor kNairobiBlueToolbar = SkColorSetRGB(0x3b, 0x82, 0xf6);
const SkColor kNairobiBlueTab = SkColorSetRGB(0x25, 0x63, 0xeb);
const SkColor kNairobiBlueText = SkColorSetRGB(0xFF, 0xFF, 0xFF);

// Maasai Red Theme
const SkColor kMaasaiRedFrame = SkColorSetRGB(0xce, 0x11, 0x26); // Kenya flag red
const SkColor kMaasaiRedToolbar = SkColorSetRGB(0xef, 0x44, 0x44);
const SkColor kMaasaiRedTab = SkColorSetRGB(0xdc, 0x26, 0x26);
const SkColor kMaasaiRedText = SkColorSetRGB(0xFF, 0xFF, 0xFF);
}
